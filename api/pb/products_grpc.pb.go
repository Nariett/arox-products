...
const (
	ProductsService_Gets_FullMethodName = "/products.ProductsService/Gets"
)
...
type ProductsServiceClient interface {
	Gets(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Product, error)
}
...
func (c *productsServiceClient) Gets(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Product, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Product)
	err := c.cc.Invoke(ctx, ProductsService_Gets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductsServiceServer interface {
	Gets(context.Context, *emptypb.Empty) (*Product, error)
...
func (UnimplementedProductsServiceServer) Gets(context.Context, *emptypb.Empty) (*Product, error) {
...
func _ProductsService_Gets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductsServiceServer).Gets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductsService_Gets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductsServiceServer).Gets(ctx, req.(*emptypb.Empty))
	}
...
var ProductsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Gets",
			Handler:    _ProductsService_Gets_Handler,
		},
	},
